...
const RetroVillaPage = () => {
    const villa = {
        ...
        description: 'Immerse yourself in the golden era of design at Retro Villa. This exquisitely styled homestay captures the essence of vintage luxury while offering contemporary amenities. Every corner tells a story of timeless elegance and sophisticated comfort.',
        longDescription: 'Retro Villa is a masterpiece of classic design, featuring period-appropriate furnishings, rich textures, and warm color palettes that create an atmosphere of nostalgic luxury. The property combines historical charm with modern conveniences, offering guests an authentic retro experience without compromising on comfort.',
        ...
        amenities: [
            ...
            { icon: FiTv, name: 'Vintage-style Entertainment' },
            { icon: FiCoffee, name: 'Classic Kitchen' },
            { icon: FiCar, name: 'Private Parking' },
            { icon: FiDroplet, name: 'Garden Area' },
            { icon: FiSun, name: 'Outdoor Seating' },
            { icon: FiHome, name: 'Cozy Living Spaces' },
            { icon: FiCamera, name: 'Photogenic Interiors' }
        ],
        gallery: [
    ...
    const faqs = [
        ...
        {
            question: 'What makes Retro Villa special?',
            answer: 'Retro Villa features authentic vintage décor, period furnishings, and classic design elements that transport you to a bygone era while maintaining modern comfort standards.'
        },
        {
        ...
        },
        {
            ...
            answer: 'Your stay includes access to all villa amenities, complimentary WiFi, parking, and 24/7 support. The villa features vintage-inspired interiors and classic furnishings.'
        },
        {
            question: 'How far is Retro Villa from main attractions?',
            answer: 'Retro Villa is conveniently located within easy reach of Lonavala\'s popular destinations, typically 10-20 minutes by car.'
        }
    ];
            ...
            <section className="py-20 bg-stone-50">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    >
                        ...
                        <p className="text-xl text-stone-600">A visual journey through classic charm</p>
                    </motion.div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {villa.gallery.map((image, index) => (
                            ...
                            >
                                <img
                                    src={image}
                                    alt={`Retro Villa Gallery ${index + 1}`}
            ...
            <section className="py-20 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    >
                        ...
                        <p className="text-xl text-stone-600">Explore the beauty and culture around Retro Villa</p>
                    </motion.div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    >
                        <h2 className="text-4xl font-bold text-white mb-6" style={{ fontFamily: "'Marcellus', serif" }}>
                            Ready to Experience Retro Villa?
                        </h2>
                        <p className="text-xl text-amber-100 mb-8 max-w-2xl mx-auto">
                            Book your stay now and step back in time at our classic retreat in Lonavala
                        </p>
